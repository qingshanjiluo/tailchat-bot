...
class MessageProcessor:
    ...
    def process_message(self, message: Message):
        ...
        try:
            ...
            # 新要求：不回复群聊中的非@消息
            # 只记录日志，不进行任何回复
            logger.debug(f"忽略群聊非@消息: {message.author} -> {message.content[:50]}...")
    ...
    def send_custom_message(self, converse_id: str, content: str, mentions: List[str] = None):
        """发送自定义消息"""
