...
class GitImageSupport:
    ...
    def __init__(self):
        ...
        # 支持的图片格式
        self.supported_formats = ['.jpg', '.jpeg', '.png', '.gif', '.webp', '.bmp', '.svg']
    ...
    def send_image_message(self, image_info: Dict, converse_id: str, caption: str = "") -> bool:
        """
        发送图片消息
    ...
    def create_image_catalog_message(self, images: List[Dict], title: str = "图片库") -> str:
        """
        创建图片目录消息
