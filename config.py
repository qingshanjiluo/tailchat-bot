...
class BotBehaviorConfig:
    ...
    def from_env(cls) -> 'BotBehaviorConfig':
        return cls(
            ...
            auto_reply_probability=float(os.getenv('BOT_AUTO_REPLY_PROBABILITY', '0.8')),
            max_message_length=int(os.getenv('BOT_MAX_MESSAGE_LENGTH', '1000')),
            welcome_message=os.getenv('WELCOME_MESSAGE', '你好！我是AI助手，有什么可以帮你的吗？'),
            busy_message=os.getenv('BUSY_MESSAGE', '我现在不在线，请在6:00-22:00之间联系我。')
        )
...
class ConversationConfig:
    ...
    def from_env(cls) -> 'ConversationConfig':
        return cls(
            enable_history=os.getenv('ENABLE_CONVERSATION_HISTORY', 'true').lower() == 'true',
