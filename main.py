...
class TailChatAIBot:
    ...
    def _is_active_hours(self) -> bool:
        ...
        if config.behavior.active_hours_start <= config.behavior.active_hours_end:
            ...
            # 跨天时间范围，如 22:00-6:00
            return current_hour >= config.behavior.active_hours_start or current_hour < config.behavior.active_hours_end
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "statistics": {
                ...
                "scheduled_jobs": len(active_sender.scheduler.jobs) if hasattr(active_sender, 'scheduler') else 0
            }
        }
